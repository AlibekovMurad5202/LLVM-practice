; ModuleID = 'cpp/licm_div_5.cpp'
source_filename = "cpp/licm_div_5.cpp"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  call void @_Z4funciiiiiiiiiiiiiiii(i32 %0, i32 %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef)
